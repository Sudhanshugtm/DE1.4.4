...
import { communityTipsByOutline } from '../../config/outlines/communityTips.js'
...
// The bullets live in the shared community-tips config, so the pre-editor
// guidance step and the in-editor suggestion speak from one source.
const guidanceProfilesByOutline = deepFreeze(
  Object.fromEntries(
    Object.entries(communityTipsByOutline).map(([outlineId, bullets]) => [
      outlineId,
      { ...sharedGuidance, guidanceBullets: [...bullets] },
    ]),
  ),
)

...
const journeysByKey = deepFreeze({
  'person-neil-armstrong': {
    ...
    sourceRequirements: { requiredCount: 2, profileKey: 'person' },
  ...
  'event-chandrayaan-3-landing': {
    ...
    sourceRequirements: { requiredCount: 2, profileKey: 'recent-event' },
  ...
  'object-mars': {
    ...
    sourceRequirements: { requiredCount: 2, profileKey: 'astronomical-object' },
  ...
  'software-google-earth': {
    ...
    sourceRequirements: { requiredCount: 2, profileKey: 'software' },
  ...
  'company-spacex': {
    ...
    sourceRequirements: { requiredCount: 2, profileKey: 'company' },
  ...
  'landform-mount-everest': {
    ...
    sourceRequirements: { requiredCount: 2, profileKey: 'landform' },
  ...
  'island-easter-island': {
    ...
    sourceRequirements: { requiredCount: 2, profileKey: 'island' },
